        ...
        <div>
            ...
            <div id="habitaciones">
                <?php
                    ...
                    $resultado = $galador -> query("SELECT DISTINCT * FROM habitacion WHERE n_habitacion NOT IN (SELECT n_habitacion FROM reservas WHERE (fecha_f >= '$FECHA_S' AND fecha_i <= '$FECHA_E') OR (fecha_f <= '$FECHA_S' AND fecha_i >= '$FECHA_E') AND (estado = 'Pagado')) GROUP BY nombre ORDER BY n_habitacion ASC") or die ($galador -> error);
